...
const Home = async () => {
  ...
  return (
    <CommonLayout>
      ...
      <section className="bg-white dark:bg-black pl-11 pr-6 py-20 lg:mt-0 lg:px-28 h-full lg:h-full 2xl:h-screen flex  flex-col justify-center items-center">
        <ScrollTextSection text={home_detail?.ScrollText} />
      </section>
      <section className="h-full bg-brand_green-700 2xl:h-2xl flex justify-center items-center pl-6 pr-11 py-20 lg:pl-14 lg:pr-[60px]">
        <Services services={home_detail?.ServicesPage} />
      </section>

      <section className="h-full py-10 bg-primary w-full lg:px-14 lg:min-h-[700px] 2xl:h-fit 2xl:px-0 2xl:pl-14">
        <RatingSection rating={home_detail.RatingSection} />
      </section>
      <section className="min-h-screen bg-white dark:bg-black pl-6 pr-11 py-10 flex items-center justify-center h-full lg:px-14 lg:min-h-[850px] 2xl:h-2xl">
      ...
      <section className="h-full min-h-screen 2xl:min-h-fit bg-white dark:bg-black pl-6 pr-11 py-10 lg:px-14 lg:py-20 ">
